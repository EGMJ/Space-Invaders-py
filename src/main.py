...
class Game:
    def __init__(self):
        ...
        # Health and score
        self.lives = 3
        self.live_surf = pygame.image.load('../assets/graphics/player.png')
